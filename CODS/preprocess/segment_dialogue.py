...
if __name__ == "__main__":
    st = time.time()
    process_dialogue("../SUMMscreen/mock_data/test.json", "test")
    process_dialogue("../SUMMscreen/mock_data/eval.json", "val")
    process_dialogue("../SUMMscreen/mock_data/train.json", "train")
    print(time.time() - st)
